...
import Manager.I_KeyManagement;
import Manager.KeyManager;
import Manager.I_UserManagement;
	...
	public void recoveryView() {
        ...
        saveRecovery.addActionListener(new ActionListener() {
     	    ...
     	    public void actionPerformed(ActionEvent event) { 
     	        ...
     	        I_UserManagement manageUser = new UserManager();
     	     	manageUser.setUpRecovery(recoverQuestion1.getText(), recoverAnswer1.getText(), recoverQuestion2.getText(), recoverAnswer2.getText());
	...
	public void changePassView() {
        ...
        saveChange.addActionListener(new ActionListener() {
     	    ...
     	    public void actionPerformed(ActionEvent event) { 
     	        ...
     	        I_UserManagement manageUser = new UserManager();
     	     	manageUser.changeAccountPassword(oldPassTxt.getText(), newPassTxt.getText(), newPassTxt2.getText());
		...
		// save button functionality
     	saveEdit.addActionListener(new ActionListener() {
     	    ...
     	    public void actionPerformed(ActionEvent event) { 
     	        ...
     	        I_KeyManagement manageUser = new KeyManager();
     	       manageUser.editPassword(editNewPass.getText(), "dummy", editOldPass.getText()); //gets the old and new password from textfields 
